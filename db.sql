...
CREATE TABLE `member` (
	...
	provider VARCHAR(20) NOT NULL, -- 'local', 'kakao', 'naver' 등
	providerId VARCHAR(255),                       -- 소셜 회원은 고유 ID, 자체 회원은 NULL
...
CREATE TABLE tripPlace (
	id INT(10)	UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
	tripDayId INT(10) NOT NULL
);

ALTER TABLE tripPlace
ADD COLUMN tripLocationId INT(10) UNSIGNED NOT NULL AFTER id;
