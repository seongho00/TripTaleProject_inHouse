...
<div
	class="flex flex-col justify-between items-center w-screen h-[3000px] overflow-hidden bg-white border border-[#0f0000]">
	<div
	...
	<div
		...
		<img src="/images/썸네일.png"
			class="flex-grow-0 flex-shrink-0 w-[1695px] h-[937px] object-cover" />
		<div
			...
			<p
				class="self-stretch flex-grow w-[741.5px] h-[401.68px] text-6xl text-center text-black">
				<span
					class="self-stretch flex-grow w-[741.5px] h-[401.68px] text-6xl text-center text-black">나만의
					여행 코스를 </span>
				<br />
				<span
					class="self-stretch flex-grow w-[741.5px] h-[401.68px] text-6xl text-center text-black">간편하게
					만들고</span>
			</p>
			<img src="/images/지도.png" class="flex-grow h-[401.68px] object-cover" />
		</div>
		<p
			class="self-stretch flex-grow w-[993px] h-[83px] text-6xl text-center text-black">사진과
			함께 나만의 경험을 남겨보세요</p>
		<img src="/images/게시판.png"
			class="flex-grow-0 flex-shrink-0 w-[948.46px] h-[420px] object-cover" />
		<p
			class="flex-grow-0 flex-shrink-0 w-[501px] h-[274px] text-6xl text-center text-black">
		...
		<div
			...
			<p
				class="self-stretch flex-grow-0 flex-shrink-0 w-[109px] h-[38px] text-xl font-medium text-center text-black">
				계획 만들기</p>
			<svg width="23" height="18" viewBox="0 0 23 18" fill="none"
				xmlns="http://www.w3.org/2000/svg" class="flex-grow-0 flex-shrink-0"
				preserveAspectRatio="none">
        <path d="M21 9.25L13.4051 16.75M21 9.25L13.4051 1.25M21 9.25H1"
