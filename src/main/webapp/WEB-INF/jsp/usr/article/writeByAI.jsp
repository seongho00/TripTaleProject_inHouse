...
<div class="flex flex-col justify-start items-center w-screen h-screen overflow-hidden gap-2.5 bg-white ">
	...
	<div class="flex flex-col justify-center items-center flex-grow relative overflow-hidden gap-2.5 p-2.5">
		<div
			class="flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0 relative overflow-hidden gap-2.5 pr-10">
			<p class="flex-grow-0 flex-shrink-0 w-[300px] h-[52px] text-3xl text-center text-black">AI를 이용해 기록하기</p>
		...
		<div
			...
			<p class="flex-grow-0 flex-shrink-0 w-[84px] h-[38px] text-xl font-medium text-center text-black">여행 장소</p>
		...
		<div
			...
			<div class="beforeDropFile flex-grow-0 flex-shrink-0 w-[1008px] h-[100px] font-medium text-center text-black">
				<span class="flex-grow-0 flex-shrink-0 w-[1008px] h-[222px] text-3xl font-medium text-center text-black">업로드할
					파일 놓기</span>
				<br />
				<br />
				<span class="flex-grow-0 flex-shrink-0 w-[1008px] h-[222px] text-xl font-medium text-center text-black">또는</span>
			</div>
			<div class="overflow-x-auto max-w-[1008px]">
				<div id="previewContainer" class="flex gap-4 mt-4 min-w-max"></div>
			</div>
			<div class="flex justify-center z-10 items-center relative gap-2.5 p-2.5">
		...
		<div class="mood-box flex justify-center items-center flex-wrap w-[800px] gap-[38px]">
			<div
				...
				<p class="flex-grow-0 flex-shrink-0 w-[132px] h-[31px] text-xl font-medium text-center text-black">긍정적 기분</p>
				<div
					...
					<div
						...
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">행복</p>
					</div>
					<div
						class="cursor-pointer flex justify-center items-center  h-7 relative overflow-hidden gap-2.5 px-[5px] py-2.5 rounded-[5px] bg-[#aedff7]">
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">기쁨</p>
					</div>
					<div
						class="cursor-pointer flex justify-center items-center  h-7 relative overflow-hidden gap-2.5 px-[5px] py-2.5 rounded-[5px] bg-[#aedff7]">
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">만족</p>
					</div>
					<div
						class="cursor-pointer flex justify-center items-center  h-7 relative overflow-hidden gap-2.5 px-[5px] py-2.5 rounded-[5px] bg-[#aedff7]">
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">사랑</p>
					</div>
					<div
						class="cursor-pointer flex justify-center items-center h-7 relative overflow-hidden gap-2.5 px-[5px] py-2.5 rounded-[5px] bg-[#aedff7]">
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">흥미</p>
					</div>

				</div>
				<div class="flex justify-start items-center flex-grow-0 flex-shrink-0 w-[296px] overflow-hidden gap-[3px] py-[9px]">
					<div
						class="cursor-pointer flex justify-center items-center  h-7 relative overflow-hidden gap-2.5 px-[5px] py-2.5 rounded-[5px] bg-[#aedff7]">
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">설렘</p>
					</div>
					<div
						class="cursor-pointer flex justify-center items-center  h-7 relative overflow-hidden gap-2.5 px-[5px] py-2.5 rounded-[5px] bg-[#aedff7]">
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">희망</p>
					</div>
					<div
						class="cursor-pointer flex justify-center items-center h-7 relative overflow-hidden gap-2.5 px-[5px] py-2.5 rounded-[5px] bg-[#aedff7]">
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">평온</p>
					</div>
					<div
						class="cursor-pointer flex justify-center items-center h-7 relative overflow-hidden gap-2.5 px-[5px] py-2.5 rounded-[5px] bg-[#aedff7]">
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">감사</p>
					</div>
			...
			<div
				class="flex flex-col justify-center items-center flex-grow-0 flex-shrink-0 h-[137px] w-[326px] relative overflow-hidden px-6 py-[7px] !border-2 !border-black">
				<p class="flex-grow-0 flex-shrink-0 w-[132px] h-[31px] text-xl font-medium text-center text-black">부정적 기분</p>
				<div class="flex justify-center items-center flex-grow-0 flex-shrink-0 w-[296px] overflow-hidden gap-[3px] py-[9px]">
					<div
						...
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">슬픔</p>
					</div>
					<div
						class="cursor-pointer flex justify-center items-center flex-grow h-7 relative overflow-hidden gap-2.5 px-[11px] py-2.5 rounded-[5px] bg-[#aedff7]">
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">분노</p>
					</div>
					<div
						class="cursor-pointer flex justify-center items-center flex-grow h-7 relative overflow-hidden gap-2.5 px-[11px] py-2.5 rounded-[5px] bg-[#aedff7]">
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">수치심</p>
					</div>
					<div
						class="cursor-pointer flex justify-center items-center flex-grow h-7 relative overflow-hidden gap-2.5 px-[11px] py-2.5 rounded-[5px] bg-[#aedff7]">
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">불안</p>
					</div>
					<div
						class="cursor-pointer flex justify-center items-center flex-grow h-7 relative overflow-hidden gap-2.5 px-[11px] py-2.5 rounded-[5px] bg-[#aedff7]">
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">혐오</p>
					</div>
				</div>
				<div class="flex justify-start items-center flex-grow-0 flex-shrink-0 w-[296px] overflow-hidden gap-[3px] py-[9px]">
					<div
						...
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">지루함</p>
					</div>
					<div
						class="cursor-pointer flex justify-center items-center  h-7 relative overflow-hidden gap-2.5 px-[11px] py-2.5 rounded-[5px] bg-[#aedff7]">
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">후회</p>
					</div>
					<div
						class="cursor-pointer flex justify-center items-center h-7 relative overflow-hidden gap-2.5 px-[11px] py-2.5 rounded-[5px] bg-[#aedff7]">
						<p class=" flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">아쉬움</p>
					</div>
			...
			<div
				class="flex flex-col justify-center items-center flex-grow-0 flex-shrink-0 h-[137px] w-[326px] relative overflow-hidden px-6 py-[7px] !border-2 !border-black">
				<p class="flex-grow-0 flex-shrink-0 w-[132px] h-[31px] text-xl font-medium text-center text-black">복합적 기분</p>
				<div class="flex justify-start items-center flex-grow-0 flex-shrink-0 w-[296px] overflow-hidden gap-[3px] py-[9px]">
					<div
						class="cursor-pointer flex justify-center items-center h-7 relative overflow-hidden gap-2.5 px-[11px] py-2.5 rounded-[5px] bg-[#aedff7]">
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">그리움</p>
					</div>
					<div
						class="cursor-pointer flex justify-center items-center  h-7 relative overflow-hidden gap-2.5 px-[11px] py-2.5 rounded-[5px] bg-[#aedff7]">
						<p class=" flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">민망함</p>
					</div>
					<div
						class="cursor-pointer flex justify-center items-center  h-7 relative overflow-hidden gap-2.5 px-[11px] py-2.5 rounded-[5px] bg-[#aedff7]">
						<p class="flex-grow-0 flex-shrink-0 text-xl font-medium text-center text-black">놀람</p>
					</div>
