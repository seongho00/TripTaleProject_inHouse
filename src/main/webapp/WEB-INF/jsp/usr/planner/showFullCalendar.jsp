...
<div
	...
	<div
		...
		<div
			...
			<div class="flex justify-center items-center self-stretch flex-grow relative overflow-hidden gap-2.5 p-2.5">
			...
			<div class="flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0 w-[428px] relative">
				...
				<img src="/images/사람.png" class="flex-grow-0 flex-shrink-0 w-[110px] h-[110px] object-cover" />
			</div>
		</div>
	</div>
	<div class="flex flex-col justify-center items-center self-stretch flex-grow relative overflow-hidden gap-2.5 p-2.5">
		<div
			class="flex justify-center items-center flex-grow-0 flex-shrink-0 h-[49px] relative overflow-hidden gap-2.5 px-[66px] py-0.5">
			<p class="flex-grow-0 flex-shrink-0 text-3xl text-center text-black">일정 확인</p>
		</div>
