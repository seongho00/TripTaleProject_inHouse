...
<div
	...
	<div class="flex justify-end items-center self-stretch flex-grow relative overflow-hidden gap-3 pr-2.5">
		<div
			class="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 w-[497px] relative overflow-hidden gap-1.5 border border-black">
			<div
				...
				<div class="flex justify-center items-end absolute left-[79px] top-[47px] overflow-hidden px-11 py-[13px]">
						...
						<div class="flex flex-col justify-start items-start self-stretch flex-grow gap-3">
							...
							<div
								...
								<div
									...
									<p class="flex-grow-0 flex-shrink-0 text-[15px] font-medium text-center text-black">
										02:33 ~ 4:33</p>
									<p class="flex-grow-0 flex-shrink-0 text-[15px] font-medium text-center text-black">명소
									</p>
									<p class="flex-grow-0 flex-shrink-0 text-[15px] font-medium text-center text-black">서울
										롯데타워</p>
								</div>
								<div
							...
							<div
								...
								<div
									...
									<p class="flex-grow-0 flex-shrink-0 text-[15px] font-medium text-center text-black">장소
										이름</p>
								</div>
								<div
									class="flex flex-col justify-end items-start flex-grow-0 flex-shrink-0 relative overflow-hidden gap-[18px] py-2">
