		...
		<div
			...
			<div
				...
				<div class="flex justify-center items-end h-16 absolute left-[79px] top-[47px] overflow-hidden px-11 py-[13px]">
					<p class="flex-grow-0 flex-shrink-0 w-[51px] h-[38px] text-xl font-medium text-center text-black">서울</p>
					<p class="flex-grow-0 flex-shrink-0 w-[201px] h-6 text-[15px] font-medium text-center text-black">2024.05.24 ~
						2024.05.25</p>
				</div>
				<p class="w-[141px] h-[52px] absolute left-[178.5px] top-2.5 text-3xl font-medium text-center text-black">여행 이름</p>
			</div>
			<div class="self-stretch flex-grow relative overflow-hidden">
				<p class="w-[91px] h-[39px] absolute left-[153px] top-[51px] text-xl font-medium text-center text-black">추천 장소</p>
				<p class="w-[99px] h-[37px] absolute left-[254px] top-[53px] text-xl font-medium text-center text-black/40">장소
					찾기</p>
				<div
          ...
          <path d="M0.5 0.5H82" stroke="black" stroke-linecap="round"></path>
				...
				<div class="flex flex-col justify-start items-start w-[407px] absolute left-10 top-[231px] gap-3">
					<div class="self-stretch flex-grow-0 flex-shrink-0 h-[107px] relative overflow-hidden">
						<p class="w-[53px] h-5 absolute left-[101px] top-1.5 text-[15px] font-medium text-center text-black">명소</p>
						<p class="w-[65px] h-[15px] absolute left-[108px] top-9 text-[15px] font-medium text-center text-black">장소 이름</p>
						...
						<p class="w-[39px] h-[34px] absolute left-[359px] top-[37px] text-3xl font-medium text-center text-black">➕</p>
					</div>
					<div class="self-stretch flex-grow-0 flex-shrink-0 h-[107px] relative overflow-hidden">
						<p class="w-[53px] h-5 absolute left-[101px] top-1.5 text-[15px] font-medium text-center text-black">명소</p>
						<p class="w-[65px] h-[15px] absolute left-[108px] top-9 text-[15px] font-medium text-center text-black">장소 이름</p>
				...
				<p class="w-[184px] h-[27px] absolute left-[147px] top-4 text-3xl font-medium text-center text-black">장소 선택</p>
			</div>
