...
<div
	class="flex justify-center w-screen h-screen items-center overflow-hidden gap-2.5 px-[9px] py-[7px] bg-white ">
	<div
        ...
        <path d="M0.5 1H176.5" stroke="black" stroke-opacity="0.5"></path>
			...
			<p
				class="flex-grow-0 flex-shrink-0 text-xl text-center text-black/50">또는</p>
			<svg width="177" height="2" viewBox="0 0 177 2" fill="none"
				xmlns="http://www.w3.org/2000/svg" class="flex-grow-0 flex-shrink-0"
				preserveAspectRatio="none">
        <path d="M0.5 1H176.5" stroke="black" stroke-opacity="0.5"></path>
		...
		<div
			class="flex items-center justify-center flex-col flex-grow-0 flex-shrink-0 relative h-[50px] w-[250px] overflow-hidden gap-2.5 rounded-[5px] bg-[#18a0fb]">
			<a
				class="flex items-center justify-center text-xl text-white"
				href="join">ID / PW 회원가입</a>
		</div>
	</div>
</div>
