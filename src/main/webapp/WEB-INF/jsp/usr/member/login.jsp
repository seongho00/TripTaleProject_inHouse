...
<div
	...
	<div class="flex rounded-[10px] border border-black bg-white" style="box-shadow: 4px 4px 4px 0 rgba(0, 0, 0, 0.25);">
		<div
			...
			<div class="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 overflow-hidden gap-1 px-2">
				<div class=" w-[350px] flex justify-between items-center gap-[20px] px-7">
					...
					<a class="flex-grow-0 flex-shrink-0 text-[11px] text-center text-[#757678]" href="#" onclick="openFindLoginPage()">forgot
						ID OR password?</a>
        ...
        <path d="M0.5 1H176.5" stroke="black" stroke-opacity="0.5"></path>
				...
				<div
					...
					<div class="flex w-full ">
						<a class="signUpButton flex-grow-0 flex-shrink-0 text-[13px] text-center text-[#0000EE]" href="#">Create your
							account</a>
					</div>
		...
		<div class="joinImg hidden w-[800px] h-[500px] relative">
			...
			<div class="absolute left-[30px] top-[530px] flex items-center justify-center">
		...
		<div
			...
			<div
				...
				<button form="joinForm" class="w-full flex-grow-0 flex-shrink-0 text-2xl text-center text-white cursor-pointer">SIGN
					UP</button>
			</div>
